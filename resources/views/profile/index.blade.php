        ...
        <div class="row">
          ...
          <div class="col-md-9 form">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="second_name" value="{{ $profile->second_name }}">
            </div>
            <div class="form-group">
              <label for="birth_date">Дата народження</label>
              <input type="text" class="form-control" id="birth_date" value="{{ $profile->birth_date }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="student" value="{{ $profile->student }}">
            </div>
            <div class="form-group">
              @if( $profile->student)
                <label for="doc_number">Номер студентського квитка</label>
              @else
                <label for="doc_number">Номер паспорта</label>
              @endif
              <input type="text" class="form-control" id="doc_number" value="{{ $profile->doc_number }}">
            </div>
            <div class="form-group">
              <label for="room">Кімната</label>
              <input type="text" class="form-control" id="room" value="{{ $profile->room->number }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="balance" value="{{ $profile->balance }}">
              <a class="btn btn-default" href="#" role="button">Поповнити баланс</a>
            </div>
