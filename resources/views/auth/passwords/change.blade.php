      ...
      @if (session('success'))<div class="alert alert-success">{{ session('success') }}</div>@endif
        <form class="form-horizontal" method="POST" action="{{ route('changePassword') }}">
          ...
          <div class="form-group{{ $errors->has('current-password') ? ' has-error' : '' }}">
            <label for="new-password" class="col-md-4 control-label">Старий пароль</label>
            <div class="col-md-8">
          ...
          <div class="form-group{{ $errors->has('new-password') ? ' has-error' : '' }}">
            <label for="new-password" class="col-md-4 control-label">Новий пароль</label>
            <div class="col-md-8">
          ...
          <div class="form-group">
            <label for="new-password-confirm" class="col-md-4 control-label">Підтвердження нового паролю</label>
            <div class="col-md-8">
